 ...
 * Critical production paths must fail closed when a required integration is absent.
 */
export const env = {
...
export const isTwilioWebhookVerificationConfigured = Boolean(env.twilioAuthToken)
